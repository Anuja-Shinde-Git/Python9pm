...
for i in students:
    if i["age"] > 18:
      drive.append((i["firstName"]+ ":" + "can drive")  )
    else:
       drive.append((i["firstName"]+ ":" + "can not drive") )
print(drive)       


drive = [(i["firstName"]+ ":" + "can drive") if i["age"]>18 else (i["firstName"]+ ":" + "can not drive") for i in students]
print(drive)